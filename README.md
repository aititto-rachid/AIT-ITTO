...
![iPhone](https://img.shields.io/badge/iPhone_13_Pro-000000?style=flat&logo=apple&logoColor=white)
...
class Rachid:
    name = "Rachid"
    role = "Django Developer | AI Content Creator | Digital Products Builder"

    learning = ["Python", "Django", "AI tools", "Content creation"]
    working_on = ["Web projects", "E-commerce ideas", "Educational YouTube content"]
    interests = ["AI", "Django", "Digital business", "Moroccan creative projects"]

    motto = "Build useful projects, learn daily, and share value."
